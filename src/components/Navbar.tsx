...
export const Navbar = () => {
  ...
  return (
    <>
      <header className="border-b-[1px] w-full  top-0 z-40  bg-white dark:border-b-slate-700 dark:bg-background">
            ...
            <span className="flex md:hidden gap-2">
              ...
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent side={"left"}>
                  <SheetHeader>
                    <SheetTitle className="font-bold text-xl">Home</SheetTitle>
                  </SheetHeader>
